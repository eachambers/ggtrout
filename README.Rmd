...
Below are some examples of using the ggtrout palettes. As you can see, you can adapt these palettes for use in `ggplot2()`. 

```{r examples, message = FALSE, fig.width = 5, fig.height = 5}
library(ggplot2)
library(cowplot)
library(tibble)
library(dplyr)
